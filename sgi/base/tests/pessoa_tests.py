...
class PessoaTestCase(TestCase):
    ...
    def test_pessoa_p1_exists(self):
        ...
        self.assertEqual(p1.nome_razao_social, "Instituto Federal de Rondônia - IFRO")
    ...
    def test_pessoa_p1_tem_enderecos(self):
        ...
        self.assertEquals(
            end1.pessoa.nome_razao_social, "Instituto Federal de Rondônia - IFRO"
        )
        ...
        self.assertGreater(
            self.p1.base_endereco_related.count(), 1, "não existe mais de 1 endereco"
        )
    ...
    def test_pessoa_p1_tem_contato_social(self):
        ...
        c1_whatsapp = ContatoSocial(
            tipo=ContatoSocial.Tipo.WHATSAPP.value,
            valor="+55 69 9.9999-1234",
            pessoa=self.p1,
        )
    ...
    def test_pessoa_p1_tem_telefones(self):
        ...
        c1_cel = Telefone(
            tipo=Telefone.Tipo.CEL, numero="69 9.9999-1234", pessoa=self.p1
        )
