...
class CreateView(generic.CreateView):
    ...
    success_message = (
        model._meta.verbose_name + " com CNPJ n. %(cnpj)s cadastrada com sucesso!"
    )
...
class UpdateView(generic.UpdateView):
    ...
    # pylint: disable=no-member
    success_message = (
        model._meta.verbose_name + " com CNPJ n. %(cnpj)s atualizada com sucesso!"
    )
    template_name = "base/generic_form.html"
...
class DeleteView(generic.DeleteView):
    ...
    # pylint: disable=no-member
    success_message = (
        model._meta.verbose_name + " com CNPJ n. %(cnpj)s excluída permanentemente!"
    )
